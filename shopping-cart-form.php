...
<!-- Page Title -->
<title>Payment | Kigata Technical Institute</title>
...
<div id="wrapper" class="clearfix">
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#">Pages</a>
                <ul class="dropdown">
                  ...
                  <li><a href="events-list-no-sidebar.html">Events</a>
              ...
              <li class="active"><a href="page-contact-style4.html">Contact</a>
                <!-- <ul class="dropdown">
  ...
  <!-- Start main-content -->
  <div class="main-content bg-lighter" id="fm">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="my_images/bg6.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white text-center">Payment</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#">Home</a></li>
                <li><a href="#">Pages</a></li>
                <li class="active text-gray-silver">Payment</li>
              </ol>
            </div>
          </div>
        </div>
...
<form action="pesapal-iframe.php" method="post">
	<table>
		...
		<tr>
			<td>Type:</td>
			<td><input type="text" name="type" value="PAYMENT" readonly="readonly" />
			(leave as default - ONLINE PAYMENT)
			</td>
		</tr>
		<tr>
			<td>Description:</td>
